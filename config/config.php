...
} # list of timezones here http://php.net/manual/en/timezones.php Europe/Paris Europe/Madrid Europe/London etc.
$default_language = 'en';
$debug_mode = false;
if (function_exists('navigatorLanguage')) {
...
#############################################################
$default_storage_folder = '/data/storage';
$default_path = $default_storage_folder . '/uploads/';                                                # upload folder
$default_private = $default_storage_folder . '/private/';                                            # private folder
$default_thumbs =  $default_storage_folder . '/thumbs/';
